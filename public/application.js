...
/***/ (function(module, exports, __webpack_require__) {
	...
	var voice = __webpack_require__(8);
...
/***/ (function(module, exports) {
	...
	var menu = document.querySelector('#top-right-box');
	var menuOptions = document.querySelector('.menu-boxes');
	var webcam = document.querySelector('.player');
	var gameButtons = document.querySelector('.game-buttons');
	var rules = document.querySelector('.rules');
	var pointDisplay = document.querySelector('.points');
	var map = false;
	var points = 0;
	var range = void 0;
	var rgb = {
	...
	var pixelMatcherOne = setInterval(function () {
	...
	var pixelMatcherTwo = setInterval(function () {
	...
	var calibrate = function calibrate() {
	  ...
	  var i = -4;
	  var count = 0;
	  var data = ctx.getImageData(0, 450, 30, 30);
	  ...
	  var redLow = rgb.r - 40;
	  var redHigh = rgb.r + 40;
	  var greenLow = rgb.g - 40;
	  var greenHigh = rgb.g + 40;
	  var blueLow = rgb.b - 40;
	  var blueHigh = rgb.b + 40;
	...
	function startGame() {
	  ...
	  var axisRefresher = setInterval(function () {
	    axisChanger();
	  }, speed);

	  var gamePixelMatcher = setInterval(function () {
	    beginPlayingGame();
	  }, 100);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var lastWord = function lastWord(transcript) {
	...
	function speak(e) {
	  ...
	  if (transcript.includes('male voice') || transcript.includes('female voice')) {
	    changeVoice();
	    var message = 'I now have a different voice';
	    loadVoices(message);
	  }
	  ...
	  if (transcript.includes('what') && transcript.includes('weather') && transcript.includes('in')) {
	    var weather = 'http://api.openweathermap.org/data/2.5/weather?q=' + ('' + lastWord(transcript)) + '&units=Imperial&appid=be4c79b49fa3a22cac7b890800d537b9';
	    console.log(weather);
	    $.ajax({
	      dataType: 'jsonp',
	      url: weather
	      ...
	      console.log(results);
	      var message = 'It is ' + Math.round(results.main.temp) + 'degrees in ' + results.name + 'with ' + results.weather[0].description;
	      loadVoices(message);
	    });
	  }

	  if (transcript.includes('search Google for')) {
	    var search = transcript.slice(18, transcript.length);
	    var googleSearch = function googleSearch(transcript) {
	      return ('' + transcript).replace(/ /g, '+');
	    };
	    var result = googleSearch(search);
	  ...
	  if (transcript.includes('calibrate')) {
	    var minionFadeOut = function minionFadeOut() {
	      $('.minion').fadeOut(2500);
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "12415aa8c29c96e2a40eafc19cd44b9b.png";
